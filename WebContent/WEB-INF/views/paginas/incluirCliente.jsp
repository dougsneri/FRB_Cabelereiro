				...
				<div class="form-horizontal">
					...
					<form action=<c:url value="/cadcliente"/> method="post">
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="nome">Nome do Cliente:</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="genero">Gênero (M/F):</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="telefone">Telefone para Contato:</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<input type="submit" value="Incluir Cliente" class="btn btn-info" />
						</div>
